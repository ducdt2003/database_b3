...
*/
SELECT DISTINCT rental_duration AS thoi_han_thue
FROM film;
...
*/
SELECT rental_duration, COUNT(*) AS soluong_chothue
FROM film
...
*/
SELECT replacement_cost, COUNT(*) AS soluong_phim, AVG(rental_rate) AS giathue_trungbinh, 
MIN(rental_rate) AS giathue_benhat, 
MAX(rental_rate) AS giathue_lonnha
FROM film
...
*/
SELECT f.title, COUNT(fa.actor_id) AS soluong_dienvien
FROM film f
